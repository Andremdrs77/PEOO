...
class App():
    def __init__(self):
        ...
        self.Button1 = Button(self.janela, text='Inserir Aluno', command=self.TelaInserirAluno)
        self.Button1.pack(pady=20)

        self.Button2 = Button(self.janela, text='Excluir Aluno',command=self.TelaExcluir)
        self.Button2.pack(pady=20)

        self.Button3 = Button(self.janela, text='Inserir/Alterar Notas', command=self.TelaNotas)
        self.Button3.pack(pady=20)

        self.Button4 = Button(self.janela, text='Listar Aprovados', command=self.TelaListar)
        ...
        self.buttonInserir = Button(self.frame6, text='Inserir Aluno', command=self.InserirAluno)
        self.buttonInserir.pack(pady=25)


        self.frame7 = Frame(self.janela)

        self.buttonUpdate = Button(self.frame7, text='Inserir/Alterar Notas', command=self.AlterarNotas)
        self.buttonUpdate.pack(pady=25)


        self.frame8 = Frame(self.janela)

        self.buttonDelete = Button(self.frame8, text='Excluir Aluno', command=self.ExcluirAluno)
        self.buttonDelete.pack(pady=25)

        self.frame9 = Frame(self.janela)

        self.buttonList = Button(self.frame9, text='Listar Aprovados', command=self.ListarAprovados)
        self.buttonList.pack(pady=25)


        self.frame10 = Frame(self.janela)

        self.labelInfo = Label(self.frame10, text='')
        self.labelInfo.pack(pady=25)


        self.frame11 = Frame(self.janela)
        
        self.buttonOk = Button(self.frame11, text='OK', command=self.OK)
